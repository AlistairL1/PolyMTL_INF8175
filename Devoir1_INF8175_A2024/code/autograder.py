...
def loadModuleString(moduleSource):
    ...
    tmp = importlib.util.module_from_spec(k)
...
def loadModuleFile(moduleName, filePath):
    # functions directly with file path arguments then use a combination of 
    # importlib.util.spec_from_file_location() and importlib.util.module_from_spec()
